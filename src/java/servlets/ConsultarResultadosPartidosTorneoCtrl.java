 ...
 * @author DELL
 */
public class ConsultarResultadosPartidosTorneoCtrl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/arbitro/consultarResultadosPartidosTorneoVista.jsp").forward(request, response);
    }
